...
namespace HastaTakipSistemi
{
    public partial class frmIstatistic : Form
    {
        ...
        {
            SqlCommand toplam = new SqlCommand("select COUNT(*) from tbl_HastaBilgi",bgl.baglan()); //COUNT : Toplam kayıt sayısını verir.
        ...
        {
            SqlCommand ortalama = new SqlCommand("select AVG(hYas) from tbl_HastaBilgi", bgl.baglan()); //AVG : Ortalama alır.
